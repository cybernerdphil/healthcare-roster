# Healthcare Roster PWA

A Progressive Web App (PWA) for Healthcare roster management.

## Overview

This repository contains a simple offline-capable PWA for managing healthcare team rosters and availability.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/cybernerdphil/healthcare-roster-pwa.git
   ```
